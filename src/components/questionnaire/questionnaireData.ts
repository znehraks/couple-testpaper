...
export const commonQuestions = [
  ...
  [
    "이 중 다른건 다 안맞아도 '이건 꼭 맞아야한다'라고 생각하는 것은?",
    ['경제관념', '옷 입는 스타일', '음식 취향', '대화 스타일', '속궁합'],
  ],
  [
    '나는 연애를 시작할 때, 상대방과 안맞는 점이 보이면?',
  ...
  [
    '연인과 만나는 주기는?',
    ['매일봐도 부족하다', '주 1회면 적당하다', '주 2~3회면 적당하다', '2주에 1회면 적당하다', '월 1회면 적당하다'],
  ],
  [
    '내가 원하는 데이트 스타일은?',
    [
